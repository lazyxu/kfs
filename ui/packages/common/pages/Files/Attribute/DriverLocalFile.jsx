import { getDriverLocalFile, getDriverSync, startAllLocalFileSync, updateDriverSync } from '@kfs/common/api/driver';
import { startDriverLocalFile } from '@kfs/common/api/exif';
...
export default ({ driver }) => {
    ...
    useEffect(() => {
        fetchEventSource(`http://127.0.0.1:${getSysConfig().port}/api/v1/event/driverLocalFile/${driver.id}`, {
