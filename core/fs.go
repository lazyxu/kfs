...
type FS interface {
	...
	Upload(ctx context.Context, branchName string, dstPath string, srcPath string, uploadProcess UploadProcess, concurrent bool) (sqlite.Commit, sqlite.Branch, error)
}
